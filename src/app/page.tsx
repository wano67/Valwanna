      ...
      <section className="overflow-hidden rounded-3xl bg-white/90 shadow-soft ring-1 ring-border backdrop-blur">
        <div className="relative flex flex-col gap-4 p-8 sm:p-10">
          ...
          <p className="max-w-3xl text-lg text-slate-600">
            Coucou ! Voici les petites choses qui me font rêver en ce moment.
            Si tu veux me faire sourire comme jamais, pioche une idée ici,
            je te promets un merci tout doux (et un gros câlin). ✨
          </p>
        </div>
      </section>
